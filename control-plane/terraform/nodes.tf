...
#   security_group_id            = aws_security_group.node_security_group.id
#   referenced_security_group_id = data.aws_eks_cluster.demo_aks.vpc_config[0].cluster_security_group_id
#   from_port                    = 1025
#   to_port                      = 65535
#   ip_protocol                  = "TCP"
# }
...
#   ip_protocol                  = "TCP"
#   referenced_security_group_id = aws_security_group.node_security_group.id
#   security_group_id            = data.aws_eks_cluster.demo_aks.vpc_config[0].cluster_security_group_id
# }
